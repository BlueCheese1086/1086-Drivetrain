...
public class ModuleSparkMax extends SubsystemBase implements Module {
    ...
    public void periodic() {
        ...
        if (!drivePIDConfig.closedLoop.flatten().equals(new ClosedLoopConfig().flatten()))
            driveMotor.configure(drivePIDConfig, ResetMode.kNoResetSafeParameters, PersistMode.kNoPersistParameters);
        ...
        if (!steerPIDConfig.closedLoop.flatten().equals(new ClosedLoopConfig().flatten()))
            steerMotor.configure(steerPIDConfig, ResetMode.kNoResetSafeParameters, PersistMode.kNoPersistParameters);
