...
public class ModuleSim extends Module {
    ...
    public void periodic() {
        ...
        Logger.recordOutput(
                "/Drive/Module" + moduleId + "/PIDS/Drive_kS", driveFFController.getKs());
        Logger.recordOutput(
                "/Drive/Module" + moduleId + "/PIDS/Drive_kV", driveFFController.getKv());
        ...
        Logger.recordOutput(
                "/Drive/Module" + moduleId + "/PIDS/Steer_kS", steerFFController.getKs());
        Logger.recordOutput(
                "/Drive/Module" + moduleId + "/PIDS/Steer_kV", steerFFController.getKv());

        double driveVolts =
                driveController.calculate(driveMotor.getAngularVelocityRadPerSec())
                        + driveFFController.calculate(driveController.getSetpoint());
        double steerVolts =
                steerController.calculate(steerMotor.getAngularPositionRad())
                        + steerFFController.calculate(
                                (steerController.getSetpoint()
                                                - steerMotor.getAngularPosition().in(Radians))
                                        / 0.02);
    ...
    public Distance getDrivePosition() {
        return Meters.of(
                driveMotor.getAngularPositionRad() * DriveConstants.wheelRadius.in(Meters));
    }

    public LinearVelocity getDriveVelocity() {
        return MetersPerSecond.of(
                driveMotor.getAngularVelocityRadPerSec() * DriveConstants.wheelRadius.in(Meters));
    }

    public LinearAcceleration getDriveAcceleration() {
        return MetersPerSecondPerSecond.of(
                driveMotor.getAngularAccelerationRadPerSecSq()
